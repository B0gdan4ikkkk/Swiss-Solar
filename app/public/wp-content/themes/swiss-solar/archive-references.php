...
<section class="references-archive-section w-full py-10 md:py-16 lg:pt-[192px] pb-20 bg-black">
    <div class="max-w-[1230px] mx-auto px-4">
        <!-- Заголовок секции -->
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-12 mb-12 md:mb-20 lg:mb-[232px]">
            <div class="">
            ...
            <div class="">
                <p class="text-[#757575] text-[16px] md:text-[18px] leading-[135%] max-w-[614px] lg:mr-[105px]">
